...
class TwitchBot:
    ...
    async def _handle_privmsg(self, message: str):
        ...
        try:
            ...
            channel = parts[1].split('#')[1] if '#' in parts[1] else ''
    ...
    def _cmd_info(self) -> str:
        ...
        if not self.config.cmd_info:
            return ""
        return f" LewtNanny tracks your Entropia Universe loot and stats! Use !commands to see available commands."
