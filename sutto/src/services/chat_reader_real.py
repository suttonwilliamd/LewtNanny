...
class CombatEvent(ChatEvent):
    ...
    def __init__(self, timestamp: datetime, raw_message: str, damage: float = 0.0, 
                 critical: bool = False, miss: bool = False):
...
class GlobalEvent(ChatEvent):
    ...
    def __init__(self, timestamp: datetime, raw_message: str, player: str, 
                 target: str, value: int, hof: bool = False, location: str = None):
...
class ChatLogReader:
    ...
    def _create_event_from_match(self, pattern_name: str, match: re.Match, 
                               timestamp: datetime, raw_message: str) -> Optional[ChatEvent]:
    ...
    def _create_global_event_from_match(self, pattern_name: str, match: re.Match,
                                     timestamp: datetime, raw_message: str) -> Optional[GlobalEvent]:
